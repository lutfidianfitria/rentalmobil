...
<body>
  <div class="hero_area">
    ...
    <a href=".../...rental/src/html/login.php">Login</a>
</div>
  ...
  <section class="car_section layout_padding2-top layout_padding-bottom">
    <div class="container">
      <div class="heading_container">
        <h2>
          Mobil Pilihan dengan Performa Unggulan
        </h2>
        <p>
          Setiap mobil dalam koleksi kami dipilih dengan cermat untuk memastikan performa unggulan dan kenyamanan maksimal saat Anda berkendara.
        </p>
      </div>
      <div class="car_container">
        ...
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Porsche 911 Turbo S (992) dengan mesin 3.8-liter twin-turbo, all-wheel drive, suspensi aktif, dan interior mewah, menawarkan perpaduan sempurna antara performa, kecepatan, dan kenyamanan.
            </p>
            <a href="">
              Read More
            </a>
  ...
  <section class="us_section">
    <div class="container">
      <div class="heading_container">
        ...
        <p>
          Kami berkomitmen untuk memberikan pengalaman terbaik dalam setiap perjalanan Anda dengan berbagai layanan unggulan
        </p>
      </div>
    </div>
