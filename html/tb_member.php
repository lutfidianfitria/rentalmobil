  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
     ...
     <div class="container-xxl flex-grow-1 container-p-y">
        <h2 class="mt-5">Data Member</h2>
        
        <a href="member.php"class="btn btn-primary mb-3">+ Tambah Data Member</a>
    ...
    <script src="path/to/bootstrap.bundle.js"></script> <!-- Ganti dengan path Bootstrap JS Anda -->
</body>
</html>
