  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <h5 class="card-header">History Pengembalian </h5>
...
<table class="table table-dark">
    ...
    if ($result && $result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><img src='img/" . htmlspecialchars($row['foto']) . "' alt='Gambar Buku' style='width:200px;height:200px;border-radius:0;'></td>";
            echo "<td>" . htmlspecialchars($row["Judul"]) . "</td>";
            echo "<td>" . htmlspecialchars($row["TanggalPengembalian"]) . "</td>";
            echo "<td>" . htmlspecialchars($row["StatusPeminjaman"]) . "</td>";
            echo "</tr>";

            // Insert ke tabel koleksipribadi
            $userID = $row["UserID"];
            $bukuID = $row["BukuID"];
            $insertKoleksi = "INSERT INTO koleksipribadi (UserID, BukuID) VALUES ('$userID', '$bukuID')";
            if (!$koneksi->query($insertKoleksi)) {
                echo "Error: " . $koneksi->error; // Jika ada error
            }
        }
    } else {
